...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("K-band-mini-mosaic.tar.gz", 'https://nrao-my.sharepoint.com/:u:/g/personal/psheehan_nrao_edu/IQBCQc-REEGYQrBwBu2F9uUTAfpCRQq1gYAPO18e-CL_IUk?e=jVJGNl&download=1', id='K-band-mini-mosaic')
    ]
)
